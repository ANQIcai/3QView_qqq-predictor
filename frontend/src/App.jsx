    ...
    <div style={{ display: "flex", height: "100vh", background: T.bg0, color: T.text, fontFamily: "'DM Sans',-apple-system,BlinkMacSystemFont,sans-serif", overflow: "hidden" }}>
      ...
      <main style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
          ...
          {/* ── RIGHT COLUMN ──────────────────────────────── */}
          <div style={{ width: 300, minWidth: 300, borderLeft: `1px solid ${T.border}`, overflowY: "auto", padding: "20px 16px", scrollbarWidth: "thin", scrollbarColor: `${T.borderHover} transparent` }}>
            <div style={{ height: 30 }} />
            <SectionHeader>
